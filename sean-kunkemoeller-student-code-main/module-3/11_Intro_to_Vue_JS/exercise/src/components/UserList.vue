...
>>>>>>> b94caa7f1c82a2bc6355807cecb67aaca687c194
...
<<<<<<< HEAD
      ...
      computed: {
        filteredList() {
          ...
          user.username.toLowerCase().includes(this.filter.username) &&
          user.emailAddress.toLowerCase().includes(this.filter.emailAddress) &&
