...
public class HotelService {
    ...
    public Hotel[] getHotelsByStarRating(int stars) {
        Hotel[] hotels = restTemplate.getForObject(API_BASE_URL + "hotels?stars=", Hotel[].class);
        return hotels;
    }

    public City getWithCustomQuery(){
        City city = restTemplate.getForObject("https://api.teleport.org/api/cities/geonameid%3A5128581/", City.class);
        return city;
    }
