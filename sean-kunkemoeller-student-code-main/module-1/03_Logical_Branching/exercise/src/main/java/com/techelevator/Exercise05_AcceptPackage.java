...
public class Exercise05_AcceptPackage {
    ...
    public boolean acceptPackage(int weightPounds, int lengthInches, int widthInches, int heightInches, boolean isSurchargePaid) {
        ...
        if (weightPounds <= MAX_WEIGHT_POUNDS && lengthInches * widthInches * heightInches <= 6912 && lengthInches + widthInches + heightInches > 66 && isSurchargePaid) {
            return true;
        }
        if (weightPounds <= MAX_WEIGHT_POUNDS && lengthInches * widthInches * heightInches <= 6912 && lengthInches + widthInches + heightInches < 66){
            return true;
        }
        return false;
    }}
