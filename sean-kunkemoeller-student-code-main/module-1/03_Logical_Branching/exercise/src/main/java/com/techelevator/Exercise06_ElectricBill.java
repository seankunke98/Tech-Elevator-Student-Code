...
public class Exercise06_ElectricBill {
    ...
    final double BASE_RATE = 0.20;
    final double EXCESS_RATE = 0.25;
    final double EXCESS_UNITS_LIMIT = 100.0;
    ...
    public double calculateElectricBill(double unitsUsed) {
        ...
        double excessUnits = unitsUsed - 100;
        if (unitsUsed > 100) {
            return (unitsUsed * BASE_RATE) + (excessUnits * EXCESS_RATE);
        }
        return 0;
    }
    /*
