...
public class AuctionService {
    ...
    public Auction add(Auction newAuction) {
        HttpEntity<Auction> returnedAuction = makeEntity(newAuction);
        try{
            newAuction = restTemplate.postForObject(API_BASE_URL, returnedAuction, Auction.class);
            return newAuction;
    ...
    public boolean update(Auction updatedAuction) {
        HttpEntity<Auction> returnedAuction = makeEntity(updatedAuction);
        try{
            restTemplate.put(API_BASE_URL + updatedAuction.getId(), returnedAuction);
            return true;
        } catch (RestClientResponseException | ResourceAccessException ex){
            return false;
        }
