...
public class HotelController {
    ...
    public Reservation getReservation(@Valid @PathVariable int id) throws ReservationNotFoundException {
    ...
    public List<Reservation> listReservationsByHotel(@Valid @PathVariable("id") int hotelID) throws HotelNotFoundException {
