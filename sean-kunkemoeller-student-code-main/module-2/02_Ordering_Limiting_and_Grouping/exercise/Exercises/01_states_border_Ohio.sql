...
FROM city
WHERE state_abbreviation LIKE 'PA' OR state_abbreviation LIKE 'WV' OR state_abbreviation LIKE 'KY' OR state_abbreviation LIKE 'IN' OR state_abbreviation LIKE 'MI'
