...
public class JdbcCityDao implements CityDao {
    ...
    public City getCity(int cityId) {
       //SELECT city_id, city_name, state_abbreviation, population, area FROM city WHERE city_id = 4;
        City city = new City();
...
//           city.setStateAbbreviation(result.getString("state_abbreviation"));
//           city.setPopulation(result.getInt("population"));
//           city.setArea(result.getInt("area"));
//       }
       while(result.next()){
           cityList.add(getCity(result.getInt("city_id")));
       }
    ...
    public City createCity(City city) {
        ...
        String sql = "INSERT INTO city (city_id, city_name, state_abbreviation, population, area)\n" +
    ...
    public void updateCity(City city) {
        ...
        String sql = "UPDATE city SET city_name = ?, population = ?, area = ? WHERE city_id = ?;";
